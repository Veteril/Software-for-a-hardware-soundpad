...
void Widget::SetBaseConfiguration(DeviceInfo * deviceInfo)
{
    ...
    for (int row = 0; row < 5; ++row) {
        ...
        for (int col = 0; col < 4; ++col) {
            ...
            if (row != 0){
                ...
                button->setStyleSheet("QPushButton { border-radius: 9px;  border: 2px solid black; background-color: silver;} \
    ...
    downloadMenuButton->setStyleSheet("QPushButton { ;  border: 4px solid black; background-color: silver;} \
    ...
    searchMenuButton->setStyleSheet("QPushButton { border: 4px solid black; background-color: silver;} \
        QPushButton:hover { background-color: green; } \
        QPushButton:pressed { background-color: silver; }");
    ...
    globalCheckButton->setStyleSheet("QPushButton { border-radius: 10px; border: 3px solid black; background-color: silver;} \
    QPushButton:hover { background-color: green; } \
    QPushButton:pressed { background-color: silver; }");
